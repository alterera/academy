...
import { Loader2, CheckCircle2, AlertCircle, Github, Mail } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md w-[calc(100%-2rem)] sm:w-full p-0 gap-0 overflow-hidden">
        <div className="bg-linear-to-br from-[#00E785]/10 to-[#00E785]/5 p-6 sm:p-8">
                ...
                <form onSubmit={handleLoginSendOTP} className="space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Button
                      ...
                      variant="outline"
                      disabled
                      className="w-full h-11 border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
