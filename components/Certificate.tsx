  ...
  return (
    <div className="w-full py-10 md:py-20 px-4 md:px-0">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="relative w-full rounded-lg bg-[#cafde8] border border-[#00e785] border-r-2 md:border-r-6 border-r-[#00e785] border-b-2 md:border-b-6 border-b-[#00e785]">
          {/* Content */}
          <div className="flex flex-col md:flex-row items-center justify-between p-6 md:p-10">
            ...
            <div className="flex-1 z-10 md:pr-8">
              <h2 className="text-3xl md:text-4xl font-bold pb-4">
                Get Certified with Alterera <br className="hidden md:block" />{" "}
                Academy!
              </h2>
              ...
              <ul className="list-disc pl-4 space-y-2 text-sm md:text-base">
                ...
                <li>
                  Builds credibility for portfolios, resumes, and LinkedIn.
                </li>
