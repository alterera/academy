            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-slate-700">
                  Choose the course you want and checkout quickly. Secure payments & instant access.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 flex flex-col md:flex-row gap-4 items-center">
                ...
                <div className="w-full md:w-2/3">
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    {course.chapters} Chapters • {course.videos} Videos • {course.assessments} Assessments
                  </p>
              ...
              <div className="hidden md:flex justify-between gap-4">
                ...
                <div className="flex items-start gap-3 bg-white rounded-lg p-4 w-full">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">hello@alterera.net</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-white rounded-lg p-4 w-full">
                  <CircleCheckBig className="w-8 h-8 text-emerald-600" />
                  <div>
                    <p className="text-sm font-medium text-slate-900">Get Course</p>
                    <p className="text-xs text-slate-600">Completion Certificate</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="mt-4 border-t pt-4">
                    ...
                    <div className="mt-4">
                      <CheckoutPayment
                        ...
                        razorpayKey={process.env.NEXT_PUBLIC_RAZORPAY_ID || process.env.RAZORPAY_ID || ""}
                      />
                    </div>

                    <div className="mt-3 text-xs text-slate-500">
                      Secure payment via Razorpay. You will receive a confirmation email after purchase.
                    </div>
                  </div>
                </div>
